...
<html xmlns="http://www.w3.org/1999/xhtml"  xml:lang="es" lang="es">
 ...
 <head>
   	<title>   Ajax001 - Objeto XMLHttp</title>
   	<meta http-equiv="Content-type"     content="text/html;charset=UTF-8" />
   	<script type="text/javascript"     src="ajax_02.js">   </script>
   	<!-- este link debería ser del tipo especial xml para cumplir el estándar -->
   	<link rel="stylesheet" href="ajax_02.css" type="text/css" />
 </head>
 <body>
